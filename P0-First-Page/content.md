...
This will download the latest version of Cocos2D (and its dependencies).  If you aren't comfortable using the terminal, download the project from the link [here](https://raw.githubusercontent.com/afbrandt/Update-Cocos2D-for-Xcode-7-iOS9/cocos2d-objc).  Now to update the project.  Navigate to the new version and copy three folders: cocos2d, cocos2d-ui and external.
